...
function Factory() {
  ...
  this.airbags = true;
  this.abs = true;
  this.warranty = '60,000 iles / 3 years';
}

Factory.prototype.massBuild = function(quantity, color, trim, model) {
...
class Truck extends Factory {
  constructor(model, color, trim, enginesize, hitch, bed, navigation, doors) {
    ...
    this.backupcamera = true;
    this.audio = 'basic';
    this.extendedwarranty = '150,000 miles / 6 years';
  }
}
...
const mazda3 = new Car('mazda3', 4, 'red', 'hybrid', 'automatic', 'touring', 'base', 'premium', 'leater', true);


// Print mazda3. I should have all the above properties.
// Write your code below:
console.log('Mazda 3', mazda3);
...
const miataRf = new Sport('Miata-RF', 'Grand Touring', 'manual', 'hard top', 'red', 'leater', 'premium', 'premium');
